...
type mockNormalizer struct {
	...
	normalizeFunc      func(ctx context.Context, envelope *models.RawEventEnvelope) (*ocsf.Event, error)
}
...
func (m *mockNormalizer) Normalize(ctx context.Context, envelope *models.RawEventEnvelope) (*ocsf.Event, error) {
