...
type DataSecurityFindingNormalizer struct{}

// NewDataSecurityFindingNormalizer creates a new normalizer
func NewDataSecurityFindingNormalizer() *DataSecurityFindingNormalizer {
	return &DataSecurityFindingNormalizer{}
}

// Supports checks if this normalizer handles the given event
func (n *DataSecurityFindingNormalizer) Supports(format, sourceType string) bool {
	if format != "json" {
		return false
	}
...
func (n *DataSecurityFindingNormalizer) Normalize(ctx context.Context, envelope *model.RawEventEnvelope) (*ocsf.Event, error) {
	...
	event := findings.NewDataSecurityFinding(activityID)
