...
All generated files include the following header:
...
- Code is auto-generated from OCSF specifications
- Contains no original TelHawk authorship
- Released to public domain
- Apache 2.0 license available for convenience
