...
func (s *SearchService) ListSavedSearches(ctx context.Context) ([]models.SavedSearch, error) {
	if s.repo == nil {
...
func (s *SearchService) ListSavedSearchesWithOptions(ctx context.Context, showAll bool) ([]models.SavedSearch, error) {
	if s.repo == nil {
		return nil, fmt.Errorf("repository not configured")
	}
...
func (s *SearchService) ListSavedSearchesPaged(ctx context.Context, showAll bool, page, size int) ([]models.SavedSearch, int, error) {
	if s.repo == nil {
...
func (s *SearchService) ListSavedSearchesAfter(ctx context.Context, showAll bool, cursorCreatedAt *time.Time, cursorVersionID string, size int) ([]models.SavedSearch, error) {
	if s.repo == nil {
		return nil, fmt.Errorf("repository not configured")
	}
...
func (s *SearchService) CreateSavedSearch(ctx context.Context, req *models.SavedSearchCreateRequest) (*models.SavedSearch, error) {
	if s.repo == nil {
		return nil, fmt.Errorf("repository not configured")
	}
...
func (s *SearchService) GetSavedSearch(ctx context.Context, id string) (*models.SavedSearch, error) {
	if s.repo == nil {
		return nil, fmt.Errorf("repository not configured")
	}
...
func (s *SearchService) UpdateSavedSearch(ctx context.Context, id string, req *models.SavedSearchUpdateRequest) (*models.SavedSearch, error) {
	if s.repo == nil {
		return nil, fmt.Errorf("repository not configured")
	}
...
func (s *SearchService) DeleteSavedSearch(ctx context.Context, id string) error {
	if s.repo == nil {
...
func (s *SearchService) DisableSavedSearch(ctx context.Context, id, userID string) (*models.SavedSearch, error) {
	if s.repo == nil {
		return nil, fmt.Errorf("repository not configured")
	}
	latest, err := s.repo.GetLatest(ctx, id)
...
func (s *SearchService) EnableSavedSearch(ctx context.Context, id, userID string) (*models.SavedSearch, error) {
	if s.repo == nil {
		return nil, fmt.Errorf("repository not configured")
	}
	latest, err := s.repo.GetLatest(ctx, id)
...
func (s *SearchService) HideSavedSearch(ctx context.Context, id, userID string) (*models.SavedSearch, error) {
	if s.repo == nil {
		return nil, fmt.Errorf("repository not configured")
	}
	latest, err := s.repo.GetLatest(ctx, id)
...
func (s *SearchService) UnhideSavedSearch(ctx context.Context, id, userID string) (*models.SavedSearch, error) {
	if s.repo == nil {
		return nil, fmt.Errorf("repository not configured")
	}
	latest, err := s.repo.GetLatest(ctx, id)
